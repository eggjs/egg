...
module.exports = app => {
  ...
  app.get(
    '/subObject-generator-function',
    'object.subObject.callGeneratorFunction'
  );
  app.get(
    '/subSubObject-generator-function',
    'object.subObject.subSubObject.callGeneratorFunction'
  );
  app.get(
    '/object-generator-function-arg',
    'object.callGeneratorFunctionWithArg'
  );
  ...
  app.get(
    '/class-generator-function-arg',
    'class.callGeneratorFunctionWithArg'
  );
  ...
  app.get(
    '/class-overridden-function',
    'classInherited.callOverriddenFunction'
  );
