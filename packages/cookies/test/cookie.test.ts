...
describe("test/cookie.test.ts", () => {
  it("create cookies contains invalid string error should throw", () => {
    ...
    assert.throws(
      () => new Cookie("name", "value", { path: "中文" }),
      /argument option path is invalid/,
    );
    assert.throws(
      () => new Cookie("name", "value", { domain: "中文" }),
  ...
  describe("sameSite", () => {
    ...
    describe('when set to "true"', () => {
      it('should set "samesite=strict" attribute in header', () => {
        ...
        assert.equal(
          cookie.toHeader(),
          "foo=bar; path=/; samesite=strict; httponly",
        );
      });
    });
      ...
      it('should set "samesite=none" attribute in header', () => {
        {
          ...
          assert.equal(
            cookie.toHeader(),
            "foo=bar; path=/; samesite=none; httponly",
          );
        }
        {
          const cookie = new Cookie("foo", "bar", { sameSite: "None" });
      ...
      it('should set "samesite=lax" attribute in header', () => {
        {
          ...
          assert.equal(
            cookie.toHeader(),
            "foo=bar; path=/; samesite=lax; httponly",
          );
        }
        {
          const cookie = new Cookie("foo", "bar", { sameSite: "Lax" });
  ...
  describe("priority", () => {
    ...
    describe('when set to "low"', () => {
      it('should set "priority=low" attribute in header', () => {
        ...
        assert.strictEqual(
          cookie.toHeader(),
          "foo=bar; path=/; priority=low; httponly",
        );
      });
    });
    ...
    describe('when set to "medium"', () => {
      it('should set "priority=medium" attribute in header', () => {
        ...
        assert.strictEqual(
          cookie.toHeader(),
          "foo=bar; path=/; priority=medium; httponly",
        );
      });
    });
    ...
    describe('when set to "high"', () => {
      it('should set "priority=high" attribute in header', () => {
        ...
        assert.strictEqual(
          cookie.toHeader(),
          "foo=bar; path=/; priority=high; httponly",
        );
      });
    });
