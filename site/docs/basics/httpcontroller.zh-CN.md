...
```typescript
import { HTTPController, HTTPMethod, HTTPMethodEnum, HTTPRequest, Request } from 'egg';
...
```typescript
import { Context, EggContext, HTTPController, HTTPMethod, HTTPMethodEnum } from 'egg';
