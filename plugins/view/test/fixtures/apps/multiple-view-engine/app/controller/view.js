...
exports.renderNunjucks = (ctx) =>
  ctx.render("ext/a.nj", { data: 1 }, { opt: 1 });
exports.renderWithOptions = (ctx) =>
  ctx.render("ext/a.nj", {}, { viewEngine: "ejs" });

exports.renderWithoutExt = (ctx) =>
  ctx.render("loader/a", { data: 1 }, { opt: 1 });
...
exports.renderMultipleRootWithoutExtension = (ctx) =>
  ctx.render("loader/from-view2");
...
exports.renderString = (ctx) =>
  ctx.renderString(tpl, { data: 1 }, opt).then((data) => (ctx.body = data));
