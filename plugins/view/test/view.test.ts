...
describe("test/view.test.ts", () => {
    ...
    describe("render", () => {
      it("should render ejs", async () => {
        ...
        expect(res.body.filename).toBe(
          path.join(baseDir, "app/view/ext/a.ejs"),
        );
    ...
    describe("resolve", () => {
      it("should loader without extension", async () => {
        const res = await app
          ...
          .expect(200);
        expect(res.body.filename).toBe(
          path.join(baseDir, "app/view/loader/a.ejs"),
        );
      });
      ...
      it("should load file from multiple root", async () => {
        const res = await app
          ...
          .expect(200);
        expect(res.body.filename).toBe(
          path.join(baseDir, "app/view2/loader/from-view2.ejs"),
        );
      });
      ...
      it('should render load "name" before "name + defaultExtension" in multiple root', async () => {
        ...
        expect(res.body.filename).toBe(
          path.join(baseDir, "app/view2/loader/a.nj"),
        );
      });
  ...
  describe("async function", () => {
    ...
    it("should render", async () => {
      ...
      expect(res.body.filename).toBe(
        path.join(baseDir, "app/view/ext/a.async"),
      );
