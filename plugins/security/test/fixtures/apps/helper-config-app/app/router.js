module.exports = function (app) {
  ...
  app.get(
    "/shtml-extending-domainList-via-config.helper.shtml.domainWhiteList",
    async function () {
      this.body =
        this.helper.shtml(
          '<img src="http://xx.shaoshuai.me" alt="alt"><a href="http://xx.shaoshuai.me">xx</a>',
  ...
  app.get("/shtml-stripe-css-url", async function () {
    this.body =
      this.helper.shtml(
        '<h2 style="color: red; background: url(javascript:);">xx</h2>',
      ) == "<h2 style>xx</h2>";
  });
};
