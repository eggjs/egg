...
describe("test/safe_redirect.test.ts", () => {
  ...
  it("should redirect to / when url is invaild", async () => {
    ...
    await app
      ...
      .get(
        "/safe_redirect?goto=" +
          encodeURIComponent("http://domain.com.baidu.com/domain.com"),
      )
      .expect(302)
      .expect("location", "/");
  ...
  describe("black and white urls", () => {
    ...
    it("should block illegal url", async () => {
      ...
      await app
        ...
        .get(
          "/safe_redirect?goto=" +
            encodeURIComponent("http://domain.com%0a.cn/path?abc=bar#123"),
        )
        .expect(302)
        .expect("location", "/");
    });
    ...
    it("should block evil url", async () => {
      ...
      await app
        ...
        .get(
          "/safe_redirect?goto=" +
            encodeURIComponent("http://domain.com!.a.cn/path?abc=bar#123"),
        )
        .expect(302)
        .expect("location", "/");
    });
