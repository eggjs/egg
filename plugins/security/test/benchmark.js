...
const tc7 =
  '<h1>Hello</h1><img onload="alert(1);" src="http://taobao.com/1.png" title="this is image">';
const tc8 =
...
suite
  ...
  .add(
    "Shtml helper benchmark: shtml-escape-tag-not-in-default-whitelist benchmark",
    function () {
  ...
  .add(
    "Shtml helper benchmark: ignore-domains-not-in-default-domainList benchmark",
    function () {
  ...
  .add(
    "Surl helper benchmark: protocol not in white list benchmark",
    function () {
  ...
  .add(
    "Sjson helper benchmark: unsecurity array nested json benchmark",
    function () {
