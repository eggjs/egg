...
describe("test/lib/cluster/master.test.js", () => {
  ...
  describe("spawn start", () => {
    ...
    it("should not cause master die when agent start error", (done) => {
      app = coffee.spawn("node", [utils.getFilepath("apps/agent-die/start.js")]).coverage(false);
    ...
    it("should start without customEgg", (done) => {
      app = coffee
        .fork(utils.getFilepath("apps/master-worker-started/dispatch.js"))
        // .debug()
        .coverage(false);
    ...
    it("should start without customEgg and worker_threads", (done) => {
      app = coffee
        .fork(utils.getFilepath("apps/master-worker-started-worker_threads/dispatch.js"))
        .debug()
        .coverage(false);
