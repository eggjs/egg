...
- For proper nouns such as the direct reference of a variable or a name of some plugin, we must use backtick (underneath the 'Esc') to surround them and keep what they are in origin.
