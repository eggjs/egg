...
function normalizeConfig(app) {
  ...
  if (config.httpAgent.timeout < 30000) {
    app.coreLogger.warn(
      "[egg:httpclient] config.httpclient.httpAgent.timeout(%s) can't below 30000, auto reset to 30000",
  ...
  if (config.httpsAgent.timeout < 30000) {
    app.coreLogger.warn(
      "[egg:httpclient] config.httpclient.httpsAgent.timeout(%s) can't below 30000, auto reset to 30000",
