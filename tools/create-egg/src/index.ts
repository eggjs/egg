...
const { blueBright, cyan, green, greenBright, magenta, yellow } = colors;
...
${yellow('simple')}                       egg@4 with vanilla TypeScript
${magenta('egg3-tegg')}                    egg@3 with tegg module
${cyan('egg3-simple')}                  egg@3 with vanilla TypeScript
